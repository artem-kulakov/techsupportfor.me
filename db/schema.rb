...
ActiveRecord::Schema.define(version: 20191122044441) do
  ...
  add_index "tenants", ["email_template_id"], name: "index_tenants_on_email_template_id", using: :btree
  ...
  create_table "tickets", force: :cascade do |t|
    ...
    t.string   "time_spent",               limit: 255,        default: "0:00", null: false
  end
  ...
  add_index "users", ["schedule_id"], name: "index_users_on_schedule_id", using: :btree
